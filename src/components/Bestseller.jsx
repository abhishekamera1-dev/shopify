...
//                 price: '$380.00',
//                 image: 'https://prestige-theme-allure.myshopify.com/cdn/shop/products/Le-Gina-Liege-Petrole-01.jpg?v=1676886232&width=1000',
//                 secondaryImage: 'https://prestige-theme-allure.myshopify.com/cdn/shop/products/Le-Gina-Liege-Petrole-04.jpg?v=1677243433&width=1000',
//                 badge: 'NEW'
//             },
//             {
//                 id: 3,
...
//                 price: '$380.00',
//                 image: 'https://prestige-theme-allure.myshopify.com/cdn/shop/products/Elegant-Cuir-Miroir-Chocolat-01.jpg?v=1676886288&width=1000',
//                 secondaryImage: 'https://prestige-theme-allure.myshopify.com/cdn/shop/products/Elegant-Cuir-Miroir-Chocolat-02.jpg?v=1677139259&width=1000',
//                 badge: 'NEW'
//             },
//             {
//                 id: 4,
...
//                 price: '$450.00',
//                 image: 'https://prestige-theme-allure.myshopify.com/cdn/shop/products/Grand-Nova-Lisse-Ivoire-01.jpg?v=1676886728&width=1000',
//                 secondaryImage: 'https://prestige-theme-allure.myshopify.com/cdn/shop/products/Grand-Nova-Lisse-Ivoire-02.jpg?v=1677153834&width=1000',
//                 badge: 'BEST SELLER'
//             }
//         ],
//         Men: [
...
//                 price: '$420.00',
//                 image: 'https://prestige-theme-allure.myshopify.com/cdn/shop/products/Weekender-Petit-Graine-Noir-01.jpg?v=1676887507&width=1000',
//                 secondaryImage: 'https://prestige-theme-allure.myshopify.com/cdn/shop/products/Weekender-Petit-Graine-Noir-03.jpg?v=1677260830&width=1000',
//                 badge: 'NEW'
//             },
//             {
//                 id: 6,
...
//                 price: '$320.00',
//                 image: 'https://prestige-theme-allure.myshopify.com/cdn/shop/products/Cartable-Cuir-Graine-Bleu-01.jpg?v=1676887521&width=1000',
//                 secondaryImage: 'https://prestige-theme-allure.myshopify.com/cdn/shop/products/Cartable-Cuir-Graine-Bleu-02.jpg?v=1681404611&width=1000',
//                 badge: null
//             },
//             {
//                 id: 7,
...
//                 price: '$420.00',
//                 image: 'https://prestige-theme-allure.myshopify.com/cdn/shop/products/Le-Nouveau-Cartable-Buffle-Kaki-01.jpg?v=1676887385&width=1000',
//                 secondaryImage: 'https://prestige-theme-allure.myshopify.com/cdn/shop/products/Le-Nouveau-Cartable-Buffle-Kaki-02.jpg?v=1677260284&width=1000',
//                 badge: null
//             },
//             {
//                 id: 8,
...
//                 price: '$470.00',
//                 image: 'https://prestige-theme-allure.myshopify.com/cdn/shop/products/Weekender-Graine-Noir-01.jpg?v=1676887357&width=1000',
//                 secondaryImage: 'https://prestige-theme-allure.myshopify.com/cdn/shop/products/Weekender-Graine-Noir-03.jpg?v=1677259382&width=1000',
//                 badge: 'BEST SELLER'
//             }
//         ]
//     };
        ...
        <section id="bestseller" className="py-12 md:py-20 bg-[#EFEFEF]">
            <div className="w-full px-4 md:px-6">
                ...
                <div className="flex flex-col items-center gap-4 md:gap-6 mb-10 md:mb-16">
                    <p className="text-[10px] md:text-[12px] tracking-[0.18em] uppercase font-medium text-gray-400">
                        Our best sellers
                    </p>
                    ...
                    <div className="flex gap-8 md:gap-10">
                        {['Women', 'Men'].map((tab) => (
                            <button
                                ...
                                className={`text-[18px] md:text-[24px] tracking-[0.15em] uppercase transition-all duration-300 relative pb-2 ${activeTab === tab
                                    ? 'text-black'
                ...
                <div className="flex overflow-x-auto md:grid md:grid-cols-2 lg:grid-cols-4 gap-x-4 md:gap-x-8 gap-y-8 md:gap-y-12 snap-x snap-mandatory scrollbar-hide pb-4 -mx-6 px-6 md:mx-0 md:px-0">
                    {products[activeTab].map((product) => (
                        <div
                            key={product.id}
                            className="min-w-[65vw] sm:min-w-[45vw] md:min-w-0 group cursor-pointer snap-start"
                        >
                            <div className="relative aspect-[4/5] overflow-hidden mb-3 md:mb-6">

                                {product.badge && (
                                    <span className="absolute top-4 left-4 z-10 bg-white px-3 py-1 text-[10px] tracking-[0.1em] font-semibold">
                                        {product.badge}
                                    </span>
                                )}
                            ...
                            <div className="text-center flex flex-col gap-1 md:gap-2">
                                <h3 className="text-[13px] tracking-[0.1em] uppercase text-gray-900 group-hover:text-gray-600 transition-colors line-clamp-2 px-2">
                                    {product.title}
                                </h3>
                ...
                <div className="mt-12 md:mt-24 flex justify-center">
                    <a
                        href="#"
                        className="inline-block px-6 py-3 text-[11px] tracking-[0.2em] uppercase font-medium border border-black hover:bg-black hover:text-white transition-all duration-300"
                    >
